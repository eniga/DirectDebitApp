...
namespace DirectDebitApi.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        // GET: api/values
        [HttpGet]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(IEnumerable<Customers>))]
        ...
        public ActionResult Post([FromBody] Customers item)
        {
        ...
        public ActionResult Put(int id, [FromBody] Customers item)
        {
