...
namespace DirectDebitApi.Controllers
{
    ...
    public class AppUserPreferencesController : Controller
    {
        ...
        private ILogger<AppUserPreferencesController> logger;

        public AppUserPreferencesController(IAppUserPreferenceService service, ILogger<AppUserPreferencesController> logger)
        {
