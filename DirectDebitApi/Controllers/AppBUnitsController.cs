...
namespace DirectDebitApi.Controllers
{
    ...
    public class AppBUnitsController : Controller
    {
        ...
        public AppBUnitsController(IAppBUnitService service)
        {
        ...
        public ActionResult Post([FromBody] AppBUnits item)
        {
        ...
        public ActionResult Put(int id, [FromBody] AppBUnits item)
        {
