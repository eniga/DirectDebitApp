...
namespace DirectDebitApi.Controllers
{
    ...
    public class AppLoansLogsController : Controller
    {
        private IAppLoansLogService service;
        private ILogger<AppLoansLogsController> logger;

        public AppLoansLogsController(IAppLoansLogService service, ILogger<AppLoansLogsController> logger)
        {
        ...
        // GET: api/values
        [HttpGet]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(IEnumerable<AppLoansLogs>))]
        ...
        // GET api/values/5
        [HttpGet("{id}")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(AppLoansLogs))]
        ...
        // POST api/values
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status201Created, Type = typeof(AppLoansLogs))]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(Response))]
        public async Task<ActionResult> PostAsync([FromBody] AppLoansLogs item)
        {
            if (!ModelState.IsValid)
                return BadRequest();
            try
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(Response))]
        public async Task<ActionResult> PutAsync(int id, [FromBody] AppLoansLogs item)
        {
