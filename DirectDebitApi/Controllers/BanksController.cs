...
namespace DirectDebitApi.Controllers
{
    ...
    public class BanksController : Controller
    {
        ...
        private ILogger<BanksController> logger;

        public BanksController(IBankService service, ILogger<BanksController> logger)
        {
        ...
        // GET: api/values
        [HttpGet]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(IEnumerable<Banks>))]
        ...
        // POST api/values
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status201Created, Type = typeof(Banks))]
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(Response))]
        public async Task<ActionResult> PutAsync(int id, [FromBody] Banks item)
        {
