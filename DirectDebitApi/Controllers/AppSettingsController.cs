...
namespace DirectDebitApi.Controllers
{
    ...
    public class AppSettingsController : Controller
    {
        ...
        private ILogger<AppSettingsController> logger;

        public AppSettingsController(IAppSettingService service, ILogger<AppSettingsController> logger)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(Response))]
        public async Task<ActionResult> PutAsync(int id, [FromBody] AppSettings item)
        {
