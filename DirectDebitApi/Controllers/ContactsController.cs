...
namespace DirectDebitApi.Controllers
{
    ...
    public class ContactsController : Controller
    {
        ...
        // GET api/values/5
        [HttpGet("{id}")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(Contacts))]
        ...
        // POST api/values
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status201Created, Type = typeof(Contacts))]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public ActionResult Post([FromBody] Contacts item)
        {
        ...
        public ActionResult Put(int id, [FromBody] Contacts item)
        {
